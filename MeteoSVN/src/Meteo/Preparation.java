...
public class Preparation {
	static ArrayList<ArrayList<unit>> unités = new ArrayList<ArrayList<unit>>(10);
	...
	public static void create_units() throws Exception{
		...
		Capteur_base capteur=new girouette(Preparation.unités_direction, "girouette", Random0_360);
	};
}
